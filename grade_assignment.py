...
@click.argument("wlxt_xls", type=click.Path(exists=True, dir_okay=False))
@click.argument("output_xls", type=click.Path(dir_okay=False, writable=True))
...
def grade(
    input_csv: str, wlxt_xls: str, late_csv: str, assignment_name: str, output_xls: str,
